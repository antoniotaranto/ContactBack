...
public class AgentLoginController {
    ...
    @RequestMapping(value = "/AgentLoginControl", method = { RequestMethod.GET })
    public ModelAndView Get(HttpServletResponse response) throws Exception {
        ...
        ModelAndView mv = new ModelAndView("AgentLoginControl");
        mv.addObject("today", new SimpleDateFormat("dd/MM/yyyy").format(new Date()) );
        return mv;
    }

    @RequestMapping(value = "/AgentLoginControl", method = { RequestMethod.POST })
