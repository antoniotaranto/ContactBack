...
<form method="POST" id="formExport" action="GenerateReport">
	...
	jQuery(function() {
        ...
        function formatExport(formatToExport) {
            ...
            var data = jQuery.ajax({
                url: '/CAC/Controls/QueueDetailsControl',
                processData: false,
    ...
    <fieldset class="formList">
        <legend><span class="fixpng"><b>FILTRO PARA RELATÓRIO - Fila Detalhada</b></span></legend>
        <ul>
            <li>
            ...
            <li>
                ...
                <input type="hidden" name="Report" value="queueDetails" />
