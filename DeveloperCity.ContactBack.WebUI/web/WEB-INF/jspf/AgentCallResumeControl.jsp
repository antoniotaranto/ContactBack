...
<form method="POST" id="formExport" action="GenerateReport">
	...
	jQuery(function() {
        ...
        function formatExport(formatToExport) {
            ...
            var data = jQuery.ajax({
                url: '/CAC/Controls/AgentCallResumeControl',
                processData: false,
    ...
    <fieldset class="formList">
        <legend><span class="fixpng"><b>FILTRO PARA RELATÓRIO - Resumo de Atendimentos de Agentes</b></span></legend>
        <ul>
            <li>
            ...
            <li>
                ...
                <input type="hidden" name="Report" value="agentCallResume" />
