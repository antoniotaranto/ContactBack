...
<form method="POST" id="formExport" action="ChartAgentLoginControl">
    ...
    <fieldset id="chartFilterForm" class="formList">
        ...
        <ul>
            ...
            <li>
                <input type="button" name="btnPrintChart" value="Gerar" onclick="javascript:filterComplete('ChartAgentLoginControl', 'startDate=' + jQuery('#txtStartDate').val() + '%26endDate=' + jQuery('#txtEndDate').val())" />
            </li>
        </ul>
    </fieldset>
</form>
