...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <![endif]-->
        <script language="javascript" type="text/javascript" src="/CAC/resources/SCRIPT/BackOfficeBlackList.js"></script>
                ...
                <div class="inside two-column-left">
                    <div class="breadcrumb">
                        ...
                        <ul>
                            ...
                            <li class="active last"><a href="${rootPath}BackOffice/BlackList" class="active">Cadastro de Lista Negra</a></li>
                        </ul>
                    </div>

                    <c:import url="/Controls/MainMenuControl/BackOffice/BlackList"></c:import>
                    ...
                    <div class="content">
                        ...
                        <div id="blackListItemDetails" style="display:none; cursor: default">
