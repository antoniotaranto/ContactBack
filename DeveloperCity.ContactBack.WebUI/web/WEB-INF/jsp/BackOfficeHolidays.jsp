...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <![endif]-->
        <script language="javascript" type="text/javascript" src="/CAC/resources/SCRIPT/BackOfficeHolidays.js"></script>
                ...
                <div class="inside two-column-left">
                    <div class="breadcrumb">
                        ...
                        <ul>
                            ...
                            <li class="active last"><a href="${rootPath}BackOffice/Holidays" class="active">Feriados</a></li>
                        </ul>
                    </div>

                    <c:import url="/Controls/MainMenuControl/BackOffice/Holidays"></c:import>
                    ...
                    <div class="content">
                        ...
                        <fieldset class="buttons">
                            <legend></legend>
                            <ul>
                                <li><a href="javascript:openItemDetails(0);">Novo Feriado</a></li>
                                <li><a href="javascript:commitHolidays();">Efetivar Feriados</a></li>
                            </ul>
                        </fieldset>
                        ...
                        <div id="holidayItemDetails" style="display:none; cursor: default">
