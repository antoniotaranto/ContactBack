...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript" charset="ISO-8859-1" src="/CAC/resources/SCRIPT/BackOfficeUsers.js"></script>
        <script language="javascript" type="text/javascript">
            ...
            function resetPasswordText() {
                return confirm("Você deseja realmente redefinir a senha do usuário para a padrão?");
            }
        </script>
    </head>
    <body>
                ...
                <div class="inside two-column-left">
                    <div class="breadcrumb">
                        ...
                        <ul>
                            ...
                            <li class="active last"><a href="${rootPath}BackOffice/Users" class="active">Usuários</a></li>
                        </ul>
                    </div>

                    <c:import url="/Controls/MainMenuControl/BackOffice/Users"></c:import>
                    ...
                    <div class="content">
                        ...
                        <fieldset class="buttons">
                            <legend></legend>
                            <ul>
                                <li><a href="javascript:openItemDetails(0);">Novo Usuário</a></li>
                            </ul>
                        </fieldset>
