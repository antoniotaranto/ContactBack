...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <![endif]-->
        <script language="javascript" type="text/javascript" src="/CAC/resources/SCRIPT/BackOfficePriorityPolicy.js"></script>
                ...
                <div class="inside two-column-left">
                    <div class="breadcrumb">
                        ...
                        <ul>
                            ...
                            <li class="active last"><a href="${rootPath}BackOffice/PriorityPolicy" class="active">Política de Prioridade</a></li>
                        </ul>
                    </div>

                    <c:import url="/Controls/MainMenuControl/BackOffice/PriorityPolicy"></c:import>
                    ...
                    <div class="content">
                        <h2>POLÍTICA DE PRIORIDADES</h2>

                        <fieldset class="buttons">
                            <legend></legend>
                            <ul>
                                <li><a href="javascript:openItemDetails(0);">Nova Política</a></li>
                                <li><a href="javascript:refreshPolicy();">Efetivar Políticas</a></li>
                            </ul>
                        </fieldset>
                        ...
                        <div id="priorityItemDetails" style="display:none; cursor: default">
