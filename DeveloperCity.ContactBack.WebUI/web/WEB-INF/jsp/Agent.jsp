                ...
                <div class="inside two-column-left">
                    <div class="breadcrumb">
                        ...
                        <ul>
                            ...
                            <li class="active last"><a href="${rootPath}Agent" class="active">Agent CockPit</a></li>
                        </ul>

                    </div>

                    <c:import url="/Controls/MainMenuControl/Agent"></c:import>
