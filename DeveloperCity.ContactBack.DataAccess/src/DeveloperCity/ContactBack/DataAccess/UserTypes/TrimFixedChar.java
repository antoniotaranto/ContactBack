 ...
 * @author lbarbosa
 */
public class TrimFixedChar implements org.hibernate.usertype.UserType {

    public int[] sqlTypes() {
        return new int[]{java.sql.Types.CHAR};
    }
    ...
    public Object nullSafeGet(ResultSet arg0, String[] arg1, Object arg2) throws HibernateException, SQLException {
        String dbValue = (String) org.hibernate.Hibernate.STRING.nullSafeGet(arg0, arg1[0]);
        if (dbValue != null) {
            return dbValue.trim();
        }
        else {
    ...
    public void nullSafeSet(PreparedStatement arg0, Object arg1, int arg2) throws HibernateException, SQLException {
        if (arg1 != null) {
            String v = ((String) arg1).trim();
            org.hibernate.Hibernate.STRING.nullSafeSet(arg0, v, arg2);
        }
        else {
            org.hibernate.Hibernate.STRING.nullSafeSet(arg0, arg1, arg2);
        }
    }
